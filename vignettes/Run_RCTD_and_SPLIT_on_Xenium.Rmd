...
For other modes of RCTD that purifies cells based on composition of spatial neighborhood, check [this vignette](https://github.com/bdsc-tds/SPLIT/blob/main/doc/Run_spatially_balanced_SPLIT_on_Xenium.html)
```{r}
